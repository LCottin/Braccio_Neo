...
MX12W::MX12W(const unsigned char ID) : Motor(ID)
{
 ...
 */
bool MX12W::move(const unsigned newPos, const bool degree, const bool blocking, const bool debug)
{
    if (degree)
 ...
 */
bool MX12W::setBaudrate(const unsigned baudrate)
{
 ...
 */
bool MX12W::setP(const unsigned char p)
{
	_P = p;
 ...
 * @returns true if correctly changed, else false
 */
bool MX12W::setI(const unsigned char i)
{
	_I = i;
 ...
 * @returns true if correctly changed, else false
 */
bool MX12W::setD(const unsigned char d)
{
	_D = d;
