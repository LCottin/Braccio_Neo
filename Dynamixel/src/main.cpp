...
int main(int argc, char const *argv[])
{
    ...
    braccio.Infos();
    braccio.stand();
    braccio.moveAll(2000, 2000, 2000, 1000, false);
    braccio.moveAll(1200, 3000, 1200, 1200, false);
    braccio.moveWristVer(3000, false);
    braccio.moveElbow(1000, false);
    braccio.moveAll(3000, 1000, 3000, 3000, false);
    braccio.Infos();
